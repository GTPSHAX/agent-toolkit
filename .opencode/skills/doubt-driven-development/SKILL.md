...
- **Repo orchestration rule**: this skill orchestrates from the main session. A specialist persona must return its report to Mandor instead of invoking another specialist.
